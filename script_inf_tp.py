...
from excel_export.excel_export_inf_tp import to_excel_v2, openpyxl_formatting_v2
from parameters.parametres_inf_tp import (I, J, K, nb_shifts, nb_semaines,
                                          part_time_I, full_time_I,
                                          staffing_constraints_week, staffing_constraints_weekend)
import os
...
if __name__ == "__main__":
    ...
    to_excel_v2(values, variable_names, dest_path="output/excel_inf_tp_v2.xlsx")
    openpyxl_formatting_v2(src_path="output/excel_inf_tp_v2.xlsx", dest_path="output/trame_inf_tp_v2.xlsx")
