...
if __name__ == "__main__":
    ...
    to_excel(values, variable_names, I, J, K, part_time_I, nb_shifts, dest_path="output/excel_inf.xlsx")
    openpyxl_formatting(I, J, src_path="output/excel_inf.xlsx", dest_path="output/trame_inf.xlsx")
